...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_epochs_decay', type=int, default=150, help='number of epochs to linearly decay learning rate to zero')# 150
        parser.add_argument('--beta1', type=float, default=0.7, help='momentum term of adam')
        parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate for adam')                                  #0.001
        ...
        parser.add_argument('--lr_decay_iters', type=int, default=100, help='multiply by a gamma every lr_decay_iters iterations')  #50
